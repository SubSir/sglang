...
class DFlashDraftModel(nn.Module):
    ...
    def __init__(self, config, quant_config=None, prefix: str = "") -> None:
        ...
        # bias on top of the target lm_head logits). The draft model owns
        # prefix_gru/embed_proj so checkpoint parameter names load unchanged; the
        # sequential rollout itself lives in speculative/domino_rollout.py.
