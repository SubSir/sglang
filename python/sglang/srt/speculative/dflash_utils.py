...
# causal_v5 is a backward-compatible alias for older internal checkpoints.
...
def parse_dflash_draft_config(*, draft_hf_config: Any) -> DFlashDraftConfig:
    ...
    # Domino fields. Public/SpecForge checkpoints may store emb_dim either at the
    ...
    if is_dflash_domino_projector(projector_type):
        ...
        if emb_dim is None:
            raise ValueError(
                "DFLASH Domino requires config.emb_dim or dflash_config.emb_dim to be set."
            )
